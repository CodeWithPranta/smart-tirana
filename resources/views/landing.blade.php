            ...
            <div class="page-column">
                <ul class="header-menu-2022 show">
                        ...
                        <li>
                            <div>
                                <div class="li">
                                    <a href="{{route('main.category', $category->slug)}}">
                                        <div class="tag-icon">

                                                <picture>
                                                    <img src="{{asset('storage/'. $category->image)}}" loading="lazy" class="tag-icon with-loader">
                                                </picture>
                                        </div>
                                        <div class="tag-name">{{$category->name}}</div>
                                    </a>
                                </div>
                            </div>
                        </li>
