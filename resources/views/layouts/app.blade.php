...
<head prefix="og: http://ogp.me/ns#">
    ...
    <title> Curated, Opinionated Shanghai Living | SmartTirana</title>

    <link rel="stylesheet" type="text/css" href="{{asset('static/css/smarttirana.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('static/css/smarttirana_v8.min.css')}}">
    {{-- Custom css --}}
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('static/images/favicon.ico')}}">
...
<script>
    ...
    <script type="text/javascript" src="{{asset('static/js/vendor.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('static/js/javascripts.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('static/js/public.min.js')}}"></script>
...
<div id="sales-request-lightbox" class="hidden lightbox">
...
<div class="hidden feedback-selects technical" id="feedback-bugreport">
...
<div class="hidden feedback-selects wrong-information" id="feedback-wronginfo">
...
<div class="hidden feedback-selects general" id="feedback-general">
